...
export class GridWithPagingAndSelectionComponent implements OnInit {
    ...
    @ViewChild('gridSelection2', /* TODO: add static flag */ { read: IgxGridComponent })
...
export class GridWithSelectionFilteringComponent {
    ...
    @ViewChild('gridSelection4', /* TODO: add static flag */ { read: IgxGridComponent })
...
export class GridCancelableComponent {
    public data = SampleTestData.foodProductData();
    @ViewChild('gridCancelable', /* TODO: add static flag */ { read: IgxGridComponent })
...
export class GridFeaturesComponent {
    ...
    @ViewChild('grid1', /* TODO: add static flag */ { read: IgxGridComponent }) public grid: IgxGridComponent;
    public data = [
        {
            Name: 'Alice',
            Age: 25
